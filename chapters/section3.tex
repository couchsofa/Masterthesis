...
\makebox[0.8cm]{$k_2$}  effektive Steifigkeit des Isolators\par
\makebox[0.8cm]{$m_2$}  Masse direkt über dem Isolator\par
\makebox[0.8cm]{$c_2$}  effektives Lehr'sches Dämpfungsmaß des Isolators $c_2 = \xi_2 2 \sqrt{m_2k_2}$\par
